...
const french: Record<string, string> = {
  ...
  "Books store Management": "Gestion des librairies",
  "Books Store Management": "Gestion des librairies",
  "Categories": "Catégories",
  "Driver Requests": "Demandes de livraison",
  "Driver Management": "Gestion des livreurs",
  "Profit Overview": "Aperçu des bénéfices",
  "Settings": "Paramètres",
  "Setting": "Paramètres",
  ...
  "Shipping Delivery": "Frais de livraison",
  "Language": "Langue",
  "Interface language": "Langue de l’interface",
  "Choose the language used throughout the admin dashboard.": "Choisissez la langue utilisée dans tout le tableau de bord administrateur.",
  "Add, edit, delete, and review book categories": "Ajoutez, modifiez, supprimez et consultez les catégories de livres",
  "Analyze your Profit Overview": "Analysez l’aperçu de vos bénéfices",
  "Books store": "Librairie",
  ...
  "For Driver Requests": "Pour les demandes de livraison",
  "Item Price": "Prix de l’article",
  "No orders found for this driver.": "Aucune commande trouvée pour ce livreur.",
  "No orders found for this store.": "Aucune commande trouvée pour cette librairie.",
  "Orders for this Driver": "Commandes de ce livreur",
  "Orders from this Store": "Commandes de cette librairie",
  "Phone Number:": "Numéro de téléphone :",
  "Recent Driver Orders Request": "Demandes de livraison récentes",
  "See Books store Management": "Consultez la gestion des librairies",
  "See Driver Management": "Consultez la gestion des livreurs",
  "See orders assigned to this driver": "Consultez les commandes affectées à ce livreur",
  "See Orders from this Store": "Consultez les commandes de cette librairie",
  "Top 3 Books Stores": "Top 3 des librairies",
  "Total Books store": "Total des librairies",
  "Total Bookstores": "Total des librairies",
  "Total Completed": "Total terminé",
  "Total Completed order": "Total des commandes terminées",
  "Total Driver": "Total des livreurs",
  "Total Driver Request": "Total des demandes de livraison",
  "Total Drivers": "Total des livreurs",
  "Total Pending": "Total en attente",
  "Total Pending order": "Total des commandes en attente",
  ...
  "Mange your Profile Information": "Gérez les informations de votre profil",
  ...
  "Admin Total Profit": "Bénéfice total administrateur",
  ...
  "Assigned Driver": "Livreur affecté",
  "Available Drivers": "Livreurs disponibles",
  ...
  "Select an available driver": "Sélectionner un livreur disponible",
  "Select driver": "Sélectionner un livreur",
  "Selected driver": "Livreur sélectionné",
  "No driver requests yet": "Aucune demande de livraison",
  "No driver requests found.": "Aucune demande de livraison trouvée.",
  "No drivers found.": "Aucun livreur trouvé.",
  "No drivers available.": "Aucun livreur disponible.",
  "No drivers match your search.": "Aucun livreur ne correspond à votre recherche.",
  "Search driver": "Rechercher un livreur",
  "Driver Profile": "Profil du livreur",
  "Driver Delivery Activity": "Activité de livraison",
  ...
  "Manage Bookstores & Drivers": "Gérez les librairies et les livreurs",
  ...
  "No parent": "Aucune catégorie parente",
  "Root Categories": "Catégories principales",
  ...
  "Manage book categories for sellers and books.": "Gérez les catégories de livres pour les vendeurs.",
  "These categories are available in the seller dashboard book form.": "Ces catégories sont disponibles dans le formulaire de livre du vendeur.",
  "Create the first category so sellers can assign it when adding books.": "Créez la première catégorie afin que les vendeurs puissent l’attribuer aux livres.",
  "Open menu": "Ouvrir le menu",
  "Close menu": "Fermer le menu",
  "Loading...": "Chargement...",
  "Loading drivers...": "Chargement des livreurs...",
  "N/A": "Indisponible",
  "Admin commission updated successfully.": "Commission administrateur mise à jour avec succès.",
  ...
  "Driver assigned successfully.": "Livreur affecté avec succès.",
  "Enter a commission between 0 and 100.": "Saisissez une commission comprise entre 0 et 100.",
  "Enter a valid delivery fee.": "Saisissez des frais de livraison valides.",
  "OTP resent successfully.": "Code OTP renvoyé avec succès.",
  ...
  "Select a driver first.": "Sélectionnez d’abord un livreur.",
  "Select an available driver first.": "Sélectionnez d’abord un livreur disponible.",
  "Shipping delivery fee updated successfully.": "Frais de livraison mis à jour avec succès.",
  "Signed in successfully.": "Connexion réussie.",
  "Something went wrong": "Une erreur est survenue",
  "Unable to sign in as admin.": "Impossible de se connecter en tant qu’administrateur.",
  "Showing 0 drivers": "Aucun livreur affiché",
  "Showing 0 orders": "Aucune commande affichée",
  "Showing 0 results": "Aucun résultat affiché",
  "All": "Tous",
  "Assign Driver": "Affecter un livreur",
  "Assigned": "Affecté",
  "Assigning...": "Affectation...",
  "Change Driver": "Changer de livreur",
  "Change Photo": "Changer la photo",
  "Current Offers": "Offres actuelles",
  "Customer": "Client",
  "Driver Accepted": "Livreur accepté",
  "Email unavailable": "E-mail indisponible",
  "Hide password": "Masquer le mot de passe",
  "Show password": "Afficher le mot de passe",
  "Phone unavailable": "Téléphone indisponible",
  "Save Category": "Enregistrer la catégorie",
  "Top level": "Niveau principal",
  "Update Commission": "Mettre à jour la commission",
  "Update Fee": "Mettre à jour les frais",
};
...
function translateDynamic(value: string) {
  ...
  const rules: Array<[RegExp, (...matches: string[]) => string]> = [
    ...
    [/^Current commission: (.+)$/, (_, amount) => `Commission actuelle : ${amount}`],
    [/^Current delivery fee: (.+)$/, (_, amount) => `Frais de livraison actuels : ${amount}`],
    ...
    [/^(\d+) deliveries$/, (_, count) => `${count} livraison${count === "1" ? "" : "s"}`],
...
function walk(root: Node, language: Language, refreshOriginal = false) {
  if (root.nodeType === Node.TEXT_NODE) {
    ...
    textNode.data = original.replace(trimmed, translated);
    return;
  }
